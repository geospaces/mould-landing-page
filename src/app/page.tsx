          ...
          <div className="grid grid-cols-12 gap-10 items-center">
            <div className="col-span-12 md:col-span-7">
              ...
              <p className="text-lg text-gray-600 max-w-[52ch] mb-8">
                Proactive alerts and analytics help you fix the root cause before damage spreads. Reduce call-outs,
                improve tenant health, and save on repairs.
              </p>
          ...
          <div className="grid grid-cols-12 gap-10 items-start">
            <div className="col-span-12 md:col-span-8">
              ...
              <p className="text-gray-600 max-w-[65ch]">
                Stop damp and mould early by combining accurate sensors with meaningful insights. We surface the
                problems that matter, not noise, and guide you to fix them quickly.
              </p>
            </div>
          ...
          <div className="grid grid-cols-12 gap-10 items-center">
            ...
            <div className="col-span-12 md:col-span-6">
              ...
              <p className="text-gray-600 mb-4">
                New standards require action on damp and mould. Our system provides the data trail and prioritised
                actions to meet obligations with confidence.
              </p>
        ...
        <Container>
          <div className="px-20">
            ...
            <div className="text-xs text-white/60 mt-6">
              © {new Date().getFullYear()} GeoSpaces. All rights reserved.
            </div>
          </div>
        </Container>
      </footer>
